...
provides the database layer. PBrain stores, searches, and retrieves personal knowledge
...
PBrain uses RAG as its core query mechanism. The compiled truth pattern is a deliberate
