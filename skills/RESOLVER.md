...
| "Brain health", "what features am I missing", "brain score" | Run `pbrain features --json` |
| "Set up autopilot", "run brain maintenance", "keep brain updated" | Run `pbrain autopilot --install --repo ~/brain` |
