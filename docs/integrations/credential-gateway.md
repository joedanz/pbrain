...
**Why this matters for PBrain:** The EA workflow needs Gmail (sender lookup before
...
*Part of the [PBrain Skillpack](../PBRAIN_SKILLPACK.md). See also: [Getting Data In](README.md)*
