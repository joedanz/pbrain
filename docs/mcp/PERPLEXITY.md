# Connect PBrain to Perplexity Computer
...
3. Add a new remote connector:
   ...
   - **Token:** your PBrain access token
...
```
Use my PBrain to search for [topic]
```
...
- The Mac app also supports local MCP servers if you prefer `pbrain serve` (stdio)
